...
package com.example.service.notification.data;
...
public final class PushNotification {
  ...
  public PushNotification(PushMessage customPushMessage, boolean isInSandbox) {
    this.customPushMessage = customPushMessage;
    this.isInSandbox = isInSandbox;
  }

  public PushMessage getCustomPushMessage() {
